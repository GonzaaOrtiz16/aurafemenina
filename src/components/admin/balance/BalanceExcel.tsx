  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      sProd.columns = [
        ...
        { header: "Precio de Lista ($)", key: "price", width: 18 },
        { header: "Precio Efectivo -10% ($)", key: "cash_price", width: 22 },
        { header: "Stock Total", key: "stock", width: 13 },
        { header: "Precio de Compra ($)", key: "cost", width: 20 },
      ...
      const instrucciones = [
        "",
        "📊 COLUMNAS PRINCIPALES (Hoja 'Productos'):",
        "   • Precio de Lista: el precio normal de venta (lo que cobrás).",
        "   • Precio Efectivo -10%: precio con descuento por pago en efectivo (calculado automáticamente).",
        "   • Precio de Compra: lo que TE COSTÓ el producto (se trae automáticamente desde el sistema).",
        "",
        "✏️ CELDAS EDITABLES (en AMARILLO):",
        "   • Precio de Compra: podés ajustarlo si querés simular otros costos.",
        "   • Unidades Vendidas: cargá cuántas vendiste para ver ganancia real.",
        "",
        "🧮 SE CALCULAN SOLAS:",
        "   • Ganancia por unidad = Precio de Lista − Precio de Compra",
        "   • Margen % = ganancia / precio de lista",
        "   • Valor del inventario = precio × stock",
        "   • Ganancia potencial total = (precio − costo) × stock",
        "",
        "📑 OTRAS HOJAS:",
        "   • Balance: resumen de totales y promedios.",
        "   • Resumen: estadísticas agrupadas por categoría.",
        "",
        "💡 Tip: guardá una copia mensual para llevar histórico.",
        "",
