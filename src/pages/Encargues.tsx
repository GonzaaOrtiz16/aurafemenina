...
function buildWhatsAppUrl(product: CustomProduct) {
    ...
    <Layout>
      <div className="container py-12 px-4">
        ...
        <div className="text-center mb-12">
          <p className="text-accent text-[10px] tracking-[0.5em] font-black uppercase mb-3">
            Exclusivo
          </p>
            ...
            : products.map((product) => (
                <div key={product.id} className="group">
                  ...
                  <div className="aspect-[3/4] overflow-hidden bg-secondary mb-4 relative">
                    ...
                    {/* Badge */}
                    <span className="absolute top-3 left-3 bg-accent text-accent-foreground text-[9px] font-bold uppercase tracking-wider px-3 py-1">
                      Por encargue
                    </span>
                  </div>

                  {/* Info */}
                  <h3 className="font-body text-sm font-bold uppercase tracking-wider mb-1">
                    {product.name}
                  </h3>
                  {product.description && (
        ...
        {!isLoading && products.length === 0 && (
          <div className="text-center py-20">
            <p className="text-muted-foreground font-body text-sm mb-2">
              Todavía no hay productos por encargue disponibles.
            </p>
